...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void llamaRegistroUsuarios(View view) {
        //Abrir una vista desde otra vista
        Intent intento = new Intent(this,RegistroUsuariosActivity.class);
        startActivity(intento);
    }
